...
public class ProductDAO {
	...
	public ProductInfo findProducInfo(String code) {
		Product product = this.findProduct(code);
		if(product == null) {
			return null;
		}
		//return ProductInfo(product.getCode(),product.getName(),product.getPrice());	
	...
	public void save(ProductForm productForm) {
		...
		if(productForm.getFileData() != null) {
			byte[] image = null;
			try {
				productForm.getFileData().getBytes();
		...
		//neu co loi tai database thi loi xe nem ra ngay leap tuwc
		session.flush();
	}
	...
	public PaginationResult<ProductInfo> queryProducts(int page,int maxResult,int maxNavigationPage){
		return queryProducts(page, maxResult, maxNavigationPage);
	}
