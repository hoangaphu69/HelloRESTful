...
import com.shoppingcart.demo.service.EmployeeService;
...
public class EmployeeController {
	...
	public String save(@Valid Employee employee, BindingResult result, RedirectAttributes redirect) {
		...
		redirect.addAttribute("success", "saved employee succesfully! ");
	...
	public String delete(@PathVariable int id, RedirectAttributes redirect) {
		...
		redirect.addFlashAttribute("success", "delete employee successfully! ");
		return "redirect:/employee";
	}
